...
class AdminBookWindow(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        self.btn_add_new = ttk.Button(self, text="Add New Book", width=30, command=self.show_add_new_window)
        self.btn_show_list = ttk.Button(self, text="Show List", width=30, command=self.show_book_list_window)
    ...
    def show_add_new_window(self):
        self.withdraw()
        self.add_new = addnewbook.AddNewBook(parent=self)
        self.add_new.grab_set()

    def show_book_list_window(self):
        self.withdraw()
        self.book_list = booklist.BookList(parent=self)
